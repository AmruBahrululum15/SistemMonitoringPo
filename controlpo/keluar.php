    ...
    <<div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                         ...
                         <a href="exportbarangkeluar.php" class="btn btn-info">Export Data</a>
                            </div>
               ...
               $ambilsemuadatanya = mysqli_query($conn, "SELECT * FROM keluar k, stock s WHERE k.id_barang = s.id_barang");
             ...
             <tr>
                 ...
                 <td>
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#Delete<?=$idk;?>">Delete</button>
                </td>
            </tr>  
                            ...
                            <h4 class="modal-title">Edit Barang</h4>
                               ...
                               <div class="modal-body">
                                <input type="text" name="no_po"value="<?=$no_po;?>" placeholder="No PO" class="form-control" required>
                                    <br>
                                   <input type="text" name="pengirim"value="<?=$pengirim;?>" placeholder="Pengirim" class="form-control" required>
                                    <br>
